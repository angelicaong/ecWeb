   ...
   <header class="new-navbar">        
    ...
    <div class ="container" id="cc-main">
       <div class ="cc-menu">
        ...
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Iced Tea</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Classic Milk Tea</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Vanilla Milk Tea</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Cookies & Cream Milk Tea</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Lemonade</button>
       </div>
       <div class ="cc-cart">
         <h3>Cart</h3>
