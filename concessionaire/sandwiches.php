   ...
   <body>
    ...
    <div class ="container" id="cc-main">
       <div class ="cc-menu">
        ...
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Clubhouse</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Ham & Cheese</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Cheese Pimiento</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Chicken</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Tuna-Egg</button>
