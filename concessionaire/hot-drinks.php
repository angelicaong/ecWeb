   ...
   <header class="new-navbar">
    ...
    <div class ="container" id="cc-main">
       <div class ="cc-menu">
        ...
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Americano</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Capuccino</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Cafe Latte</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Cafe Mocha</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Brewed Coffee</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Hot Tea</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Hot Choco</button>
