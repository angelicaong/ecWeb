   ...
   <body>
    ...
    <div class ="container" id="cc-main">
       <div class ="cc-menu">
        ...
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Fruits in season</button>
        <button type ="submit" class="btn btn-dark" id="cc-menu-items" data-toggle="modal" data-target="#qty-modal">Mango Graham</button>
