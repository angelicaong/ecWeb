...
<head>
   ...
   <div id="wrapper">
    ...
    <div class = "container" id="main-content">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        <input type="text" class = "w-full" value="₱ 1,000"></input>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap cursor-not-allowed">
        ...
        <div class = "flex flex-col ml-2 mr-2 sm:flex-row md:flex-row lg:flex-row xl:flex-row justify-center mt-6 sm:justify-end md:pr-5 lg:pr-10 xl:pr-14">
            <button class="flex-initial text-center mb-1 mx-2 px-3 py-2 rounded-md shadow-sm border border-gray-600 hover:no-underline text-ecwhite bg-ecgray text-sm uppercase tracking-wider" onclick="window.location.href='withdraw.php'">Back</button>
            <button class="flex-initial text-center mb-1 mx-2 px-3 py-2 rounded-md shadow-sm border border-gray-600 bg-eclightblue text-white hover:no-underline hover:text-ecwhite hover:bg-ecgray text-sm uppercase tracking-wider" onclick="window.location.href='withdraw.php'"><img src="../resources/images/save.png" class ="w-4 h-4 my-auto mr-2 inline">Save</button>
        </div>
    </div>
