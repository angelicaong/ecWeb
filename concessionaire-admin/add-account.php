   ...
   <header class="new-navbar">
    ...
    <div class="container">
        ...
        <div class = "buttons-save-back">
         <button type="submit" onclick="window.location.href='accounts.php'"class="btn btn-success" id="save-new-acc"><img src="../resources/images/save.png" height="20px" width="20px" id="save-icon">Save</button>
